...
- Rich library of built-in [widgets](https://github.com/shapediver/AppBuilderShared/tree/development/widgets/appbuilder/ui/) including text, images, charts (area, bar, line, round), tables, forms, accordion, saved states, scene tree explorer, attribute visualization, and more
- Easy to be extended by further types of widgets
- Great starting point for custom web apps using ShapeDiver and React

### Some hints about the code

#### AppBuilderShared submodule structure

The `src/shared` directory is a Git submodule ([AppBuilderShared](https://github.com/shapediver/AppBuilderShared)) that organizes code using a [feature-sliced design](https://feature-sliced.design/) (FSD) architecture:

- [`entities/`](https://github.com/shapediver/AppBuilderShared/tree/development/entities/) — low-level building blocks: session, viewport, parameter, export, output, stargate, and more.
- [`features/`](https://github.com/shapediver/AppBuilderShared/tree/development/features/) — higher-level domain logic: App Builder orchestration, e-commerce, model state, notifications, and more.
- [`widgets/`](https://github.com/shapediver/AppBuilderShared/tree/development/widgets/) — UI widget components that compose entities and features.
- [`shared/`](https://github.com/shapediver/AppBuilderShared/tree/development/shared/) — utilities and UI primitives shared across all layers.
- [`pages/`](https://github.com/shapediver/AppBuilderShared/tree/development/pages/) — page-level components including App Builder page templates.
