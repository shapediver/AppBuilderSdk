...
import { IAppBuilderSettings, IIAppBuilderSettingsSession } from "types/shapediver/appbuilder";
 ...
 * @returns 
 */
export default function useAppBuilderSettings(defaultSession?: IIAppBuilderSettingsSession, queryParamName = "g") {
