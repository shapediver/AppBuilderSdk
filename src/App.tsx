import { ActionIcon, AppShell, Aside, ColorScheme, ColorSchemeProvider, Header, Image, MantineProvider, Navbar, Tabs } from '@mantine/core';
import { BUSY_MODE_DISPLAY, SESSION_SETTINGS_MODE } from '@shapediver/viewer';
import { IconFileDownload, IconMoonStars, IconReplace, IconSun } from '@tabler/icons-react';
